...
$pasajero1 = new Pasajero ("Alvarez", "Alberto", "11111111", TRUE);
$pasajero2 = new Pasajero ("Barracas", "Beatriz", "22222222", FALSE);
$pasajero3 = new Pasajero ("Carrero", "Carlos", "333333333", TRUE);
$pasajero4 = new Pasajero ("Davila", "David", "444444444", FALSE);
$pasajero5 = new Pasajero ("Esposito", "Ernesto", "555555555", TRUE);

$vuelo1 = new Vuelo("America", 100);
$vuelo2 = new Vuelo("Belarusia", 200,  2);
...
echo "monto de Ambos Vuelos = ", Vuelo::Add($vuelo1, $vuelo2);
